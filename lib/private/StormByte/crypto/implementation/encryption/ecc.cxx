...
ExpectedCryptoFutureBuffer ECC::Encrypt(const Buffers::Simple& input, const std::string& publicKey) noexcept {
    try {
        CryptoPP::AutoSeededRandomPool rng;
...
ExpectedCryptoFutureBuffer ECC::Decrypt(const Buffers::Simple& encryptedBuffer, const std::string& privateKey) noexcept {
    try {
        CryptoPP::AutoSeededRandomPool rng;
