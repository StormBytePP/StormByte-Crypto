...
ExpectedCryptoFutureBuffer AES::Encrypt(const StormByte::Buffer::Simple& input, const std::string& password) noexcept {
	return EncryptHelper(input.Data(), password);
}

StormByte::Buffer::Consumer AES::Encrypt(const Buffer::Consumer consumer, const std::string& password) noexcept {
...
ExpectedCryptoFutureBuffer AES::Decrypt(const StormByte::Buffer::Simple& input, const std::string& password) noexcept {
	return DecryptHelper(input.Data(), password);
}

StormByte::Buffer::Consumer AES::Decrypt(const Buffer::Consumer consumer, const std::string& password) noexcept {
	SharedProducerBuffer producer = std::make_shared<StormByte::Buffer::Producer>();
