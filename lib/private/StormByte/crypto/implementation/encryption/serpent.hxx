...
/**
 * @namespace Serpent
 * @brief The namespace containing Serpent encryption functions.
 */
namespace StormByte::Crypto::Implementation::Encryption::Serpent {
	/**
	 * @brief Encrypts a string using Serpent.
	...
	/**
	 * @brief Encrypts a Buffer using Serpent.
	...
	/**
	 * @brief Decrypts a string using Serpent.
	...
	/**
	 * @brief Decrypts a Buffer using Serpent.
