...
ExpectedHashFutureString Blake2s::Hash(const Buffer::Simple& buffer) noexcept {
	return ComputeBlake2s(buffer.Data());
}

StormByte::Buffer::Consumer Blake2s::Hash(const Buffer::Consumer consumer) noexcept {
