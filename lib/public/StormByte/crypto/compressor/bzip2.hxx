...
#include <StormByte/crypto/compressor/typedefs.hxx>

/**
 * @namespace BZip2
 * @brief The namespace containing BZip2 compression functions.
 */
namespace StormByte::Crypto::Compressor::BZip2 {
	/**
	 ...
	 */
	STORMBYTE_CRYPTO_PUBLIC ExpectedCompressorFutureBuffer Compress(const std::string& input) noexcept;
	 ...
	 * @note The compression is performed asynchronously, and the result is returned as a future.
	 */
	STORMBYTE_CRYPTO_PUBLIC ExpectedCompressorFutureBuffer Compress(const StormByte::Buffers::Simple& input) noexcept;
	 ...
	 * @note The compression is performed asynchronously, and the result is returned as a future.
	 */
	STORMBYTE_CRYPTO_PUBLIC StormByte::Buffers::Consumer 	Compress(const Buffers::Consumer consumer) noexcept;
	 ...
	 */
	STORMBYTE_CRYPTO_PUBLIC ExpectedCompressorFutureBuffer Decompress(const std::string& input, size_t originalSize) noexcept;
	 ...
	 *       The `originalSize` parameter must match the size of the original uncompressed data.
	 */
	STORMBYTE_CRYPTO_PUBLIC ExpectedCompressorFutureBuffer Decompress(const StormByte::Buffers::Simple& input, size_t originalSize) noexcept;
	 ...
	 */
	STORMBYTE_CRYPTO_PUBLIC StormByte::Buffers::Consumer	Decompress(const Buffers::Consumer consumer, size_t originalSize) noexcept;
}