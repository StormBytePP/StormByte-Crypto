 ...
 */
namespace StormByte::Crypto::Encryption::DSA {
    /**
     ...
     */
    STORMBYTE_CRYPTO_PUBLIC ExpectedCryptoFutureString 	Sign(const std::string& message, const std::string& privateKey) noexcept;
     ...
     */
    STORMBYTE_CRYPTO_PUBLIC bool 						Verify(const std::string& message, const std::string& signature, const std::string& publicKey) noexcept;
}