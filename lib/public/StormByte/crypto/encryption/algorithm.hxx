...
namespace StormByte::Network::Encryption {
	namespace Algorithm {
		 ...
		 */
		enum class STORMBYTE_CRYPTO_PUBLIC Name: unsigned short {
			NONE,																		///< No algorithm.
		 ...
		 */
		enum class STORMBYTE_CRYPTO_PUBLIC Type: unsigned short {
		...
		constexpr STORMBYTE_CRYPTO_PUBLIC std::function<Data::Encryption::ExpectedKeyPair(const int&)> KeyGenerator() {
