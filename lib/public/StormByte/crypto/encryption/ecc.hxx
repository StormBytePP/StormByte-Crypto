 ...
 */
namespace StormByte::Crypto::Encryption::ECC {
	/**
	 ...
	 */
	STORMBYTE_CRYPTO_PUBLIC ExpectedKeyPair 				GenerateKeyPair(const int& curve_id = 256) noexcept;
	 ...
	 */
	STORMBYTE_CRYPTO_PUBLIC ExpectedCryptoFutureBuffer 		Encrypt(const std::string& message, const std::string& publicKey) noexcept;
	 ...
	 */
	STORMBYTE_CRYPTO_PUBLIC ExpectedCryptoFutureString 		Decrypt(const StormByte::Buffers::Simple& encryptedBuffer, const std::string& privateKey) noexcept;
	 ...
	 */
	STORMBYTE_CRYPTO_PUBLIC StormByte::Buffers::Consumer 	Encrypt(const Buffers::Consumer consumer, const std::string& publicKey) noexcept;
	 ...
	 */
	STORMBYTE_CRYPTO_PUBLIC StormByte::Buffers::Consumer 	Decrypt(const Buffers::Consumer consumer, const std::string& privateKey) noexcept;
}