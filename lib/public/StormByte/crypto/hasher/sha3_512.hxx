...
namespace StormByte::Crypto::Hasher {
	...
	class STORMBYTE_CRYPTO_PUBLIC SHA3_512 final: public Generic {
		public:
			 ...
			 * @param other The other SHA3_512 hasher to copy from.
			 */
			SHA3_512(const SHA3_512& other)						= default;

			/**
			 * @brief Move constructor
			 * @param other The other SHA3_512 hasher to move from.
			 */
			 ...
			 * @param other The other SHA3_512 hasher to copy from.
			 * @return Reference to this SHA3_512 hasher.
			 */
			...
			/**
			 * @brief Clone the SHA3_512 hasher.
			 * @return A pointer to the cloned SHA3_512 hasher.
			 */
			...
			/**
			 * @brief Move the SHA3_512 hasher.
			 * @return A pointer to the moved SHA3_512 hasher.
			 */
