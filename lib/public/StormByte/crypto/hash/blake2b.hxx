...
#include <StormByte/crypto/hash/typedefs.h>

/**
 * @namespace Blake2b
 * @brief Namespace for Blake2b hashing utilities.
 */
namespace StormByte::Crypto::Hash::Blake2b {
    /**
     ...
     */
    STORMBYTE_CRYPTO_PUBLIC ExpectedHashFutureString 		Hash(const std::string& input) noexcept;
     ...
     * @return Expected<std::string, CryptoException> containing the hash or an error.
     */
    STORMBYTE_CRYPTO_PUBLIC ExpectedHashFutureString 		Hash(const Buffers::Simple& buffer) noexcept;
     ...
     */
    STORMBYTE_CRYPTO_PUBLIC StormByte::Buffers::Consumer 	Hash(const Buffers::Consumer consumer) noexcept;
}